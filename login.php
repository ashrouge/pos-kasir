...
<head>
  ...
  <title>Login Arunika Collection</title>
  ...
  <div class="container">
    <!-- <form class="form" action="" method="POST">
      <div class="form_front">
        ...
        <input type="text" class="input" placeholder="Password" name="pass">
    ...
    <form class="form_container" action="" method="POST">
      ...
      <div class="title_container">
        <p class="title">Kasir Ku</p>
        <span class="subtitle">Nikmati aplikasi kasir kami hanya dengan masukan akun anda.</span>
      </div>
      <br>
      <div class="input_container">
        <label class="input_label" for="Username_failed">Username</label>
        ...
        <!-- <input placeholder="Username" title="Inpit title" name="user" type="text" class="input_field" id="email_field"> -->
        <input type="text" class="input_field" placeholder="Username" name="user">
      </div>
      <div class="input_container">
        ...
        <input type="text" class="input_field" placeholder="Password" name="pass">
      </div>
      <!-- <button name="proses" class="sign-in_btn">
        <span>Login</span>
      </button> -->
      <button name="proses" class="login">Login</button>
      ...
      <p class="note">Syarat penggunaan &amp; Ketentuan</p>
    </form>
  </div>
