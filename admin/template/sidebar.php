...
?>
<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #45474B;">

    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-icon rotate-n-15">
            <img src="./assets/img/icon.png" width="60px" alt="">
        </div>
        <div class="sidebar-brand-text mx-3">Kedai Ndeso<sup></sup></div>
    </a>
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <!-- Main Content -->
    <div id="content" style="background-color: #F3EEEA;">

        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color: #F3EEEA;">

            <!-- Sidebar Toggle (Topbar) -->
            <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
                <i class="fa fa-bars"></i>
            </button>
            <h5 class="d-lg-block d-none mt-2" style="color: #1a1a1a;"><b>Kasir Kedai Ndeso</b></h5>
            <!-- Topbar Navbar -->
